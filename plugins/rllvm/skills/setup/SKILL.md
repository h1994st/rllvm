...
not on `PATH`. On Debian/Ubuntu, LLVM comes from
...
| An archive yields nothing under LTO | a ThinLTO archive holds raw bitcode, not objects; rebuild with LTO off to extract a library |
